...
(function(window) {
    ...
    const AnimatedLogoSystem = {
        ...
        loadLogosFromGSRCDN: async function() {
            ...
            try {
                // Use GSRCDN.getData if available
                let logoData;
         ...
         * GSRCDN returns structured objects with keys
         */
        parseGSRCDNData: function(data) {
            if (!data || data.length === 0) {
                throw new Error('Invalid GSRCDN data');
            }
            ...
            data.forEach((row, index) => {
                ...
                const enabled = row.enabled !== undefined ? 
                    (row.enabled === true || row.enabled === 'true' || row.enabled === 1 || row.enabled === '1') : 
                    true;
                ...
                const eventName = row.eventName.toLowerCase().trim();
                ...
                console.log(`✅ Parsed logo event: ${eventName}`, logos[eventName]);
            });
        ...
        loadLogo: function() {
            ...
            this.preloadImage(logoUrl, () => {
                ...
                console.log('✅ Loaded logo:', logoData.alt, logoUrl);
            });
        },
...
// ============================================
// 📋 GOOGLE SHEETS FORMAT (Sheet3, Row 101+)
// ============================================
...
Example data:
default | https://www.gstatic.com/youtube/img/... | Store Logo | FALSE | - | - | FALSE | TRUE
christmas | christmas.webp | Christmas Sale | TRUE | 12-15 | 12-26 | FALSE | TRUE
newyear | newyear.webp | Happy New Year | TRUE | 12-27 | 01-05 | FALSE | TRUE
valentine | valentine.webp | Valentine Day | TRUE | 02-10 | 02-15 | FALSE | TRUE
flashsale | flashsale.webp | Flash Sale! | TRUE | - | - | TRUE | FALSE

Notes:
- GSRCDN will parse this automatically
- Dates in MM-DD format (e.g., 12-25)
