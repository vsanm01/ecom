 ...
 * Version: 1.1.0 - Modified with new design specifications
 * 
 * Usage:
            ...
            const styles = `
                <style id="pr-styles">
                    ...
                    .pr-badge {
                        ...
                        top: 10px;
                        right: 10px;
                        background: url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 120 120"><path d="M60 5 L70 35 L100 35 L75 55 L85 85 L60 65 L35 85 L45 55 L20 35 L50 35 Z" fill="%23f5e6d3" stroke="%23d4a574" stroke-width="2"/></svg>') no-repeat center;
