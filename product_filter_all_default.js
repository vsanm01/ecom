 ...
 * Version: 1.2.1 - Changed default to "All Products"
 * 
 * Dependencies:
...
class ProductFilterManager {
    constructor(options = {}) {
        ...
        this.currentCategory = 'all'; // CHANGED: Default to All Products
     ...
     */
    resetFilters() {
        this.currentCategory = 'all'; // CHANGED: Reset to All Products
