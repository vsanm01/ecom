 ...
 * Version: 1.1.1 - Fixed header row filtering
 * 
 * Dependencies:
 ...
 *   },
 *   skipHeaderRow: true // NEW: Skip first row if it's a header
 * });
 * 
 * filterManager.init();
 */
...
class ProductFilterManager {
    constructor(options = {}) {
        this.config = {
            ...
            skipHeaderRow: options.skipHeaderRow !== undefined ? options.skipHeaderRow : true, // NEW
            headerKeywords: options.headerKeywords || ['category', 'price', 'name', 'title', 'product'] // NEW
        };
    ...
    /**
     * Apply all filters (category, price, sort) - UPDATED to skip header rows and C1
     */
    applyFilters() {
