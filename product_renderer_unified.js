 ...
 * Version: 1.2.0 - Unified dark theme for all devices
 * 
 * Usage:
        ...
        injectStyles: function() {
            ...
            const styles = `
                <style id="pr-styles">
                    ...
                    /* UNIFIED ACTION BUTTONS STYLING - ALL DEVICES */
                    .pr-actions {
                        position: absolute;
                        top: 15px;
                        left: 15px;
                    ...
                    @media (max-width: 768px) {
                        ...
                        /* MOBILE ACTION BUTTONS - UNIFIED DARK THEME */
                        .pr-actions {
                            opacity: 1;
                            transform: translateX(0);
                            top: 8px;
                    ...
                    @media (max-width: 480px) {
                        ...
                        /* SMALL MOBILE ACTION BUTTONS - UNIFIED DARK THEME */
                        .pr-actions {
                            top: 6px;
                            left: 6px;
                            gap: 5px;
