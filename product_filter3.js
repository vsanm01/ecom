...
class ProductFilterManager {
    ...
    getCategories() {
        ...
        // Return in order: all, bestsellers, then other categories
    ...
    /**
     * Apply all filters (category, price, sort) - UPDATED to skip C1 and handle Best Sellers
     */
    applyFilters() {
        ...
        if (this.currentCategory === 'bestsellers') {
            ...
            // Apply price filters to best sellers if any are set
