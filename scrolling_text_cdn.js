    ...
    class ScrollingTextManager {
        constructor(options = {}) {
            this.options = {
                ...
                sheetName: options.sheetName || 'scrolling_messages',
        ...
        async loadMessagesFromSheet() {
            ...
            try {
                ...
                if (this.messages.length === 0) {
                    this.log('No valid messages found, using fallback');
                    this.messages = this.options.fallbackMessages;
                }
