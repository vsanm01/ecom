 ...
 * Version: 1.2.1 - Unified dark theme with hover behavior
 * 
 * Usage:
        ...
        injectStyles: function() {
            ...
            const styles = `
                <style id="pr-styles">
                    ...
                    /* UNIFIED BADGE STYLING - ALL DEVICES */
                    .pr-badge {
                        position: absolute;
                        top: 15px;
                        right: 15px;
                    ...
                    /* UNIFIED ACTION BUTTONS - HOVER ON DESKTOP/TABLET */
                    .pr-actions {
                        position: absolute;
                        top: 15px;
                        left: 15px;
                    ...
                    /* Tablet (769px-991px) - 3 columns, 16px gap */
                    ...
                    @media (max-width: 768px) {
                        ...
                        /* MOBILE BADGE - UNIFIED DARK THEME */
                        .pr-badge {
                            top: 8px;
                            right: 8px;
                            padding: 4px 10px;
                    ...
                    @media (max-width: 480px) {
                        ...
                        /* SMALL MOBILE BADGE - UNIFIED DARK THEME */
                        .pr-badge {
                            top: 6px;
                            right: 6px;
                            padding: 3px 8px;
                        ...
                        /* SMALL MOBILE ACTION BUTTONS - ALWAYS VISIBLE */
                        .pr-actions {
                            opacity: 1;
                            transform: translateX(0);
                            top: 6px;
