 ...
 * Version: 1.3.0 - Transparent backdrop with glassmorphism
 * 
 * Usage:
        ...
        injectStyles: function() {
            ...
            const styles = `
                <style id="pr-styles">
                    ...
                    /* UNIFIED BADGE STYLING - TRANSPARENT BACKDROP */
                    .pr-badge {
                        position: absolute;
                        top: 15px;
                        right: 15px;
                    ...
                    /* UNIFIED ACTION BUTTONS - TRANSPARENT BACKDROP */
                    .pr-actions {
                        position: absolute;
                        top: 15px;
                        left: 15px;
                    ...
                    @media (max-width: 768px) {
                        ...
                        /* MOBILE BADGE - TRANSPARENT BACKDROP */
                        .pr-badge {
                            top: 8px;
                            right: 8px;
                            padding: 4px 10px;
                    ...
                    @media (max-width: 480px) {
                        ...
                        /* SMALL MOBILE BADGE - TRANSPARENT BACKDROP */
                        .pr-badge {
                            top: 6px;
                            right: 6px;
                            padding: 3px 8px;
